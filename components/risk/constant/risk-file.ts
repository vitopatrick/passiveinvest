export const risks = [
  {
    ...
    body: `All terms used in this notice, which are defined in the Coinvestar Terms of Use (the
“Terms of Use”), have the same meaning and construction as in the Terms of Use.`,
  },
  {
    heading: "B. Coinvestar Services",
    body: `This notice provides you with information about the risks associated with Coinvestar
Services. Each Coinvestar Service has its own distinct risks. This notice provides a
general description of the risks when you use Coinvestar Services.
...
decision to use Coinvestar Services.
`,
  },
  {
...
No communication or information provided to you by Coinvestar is intended as, or
...
`,
  },
  {
    ...
    body: `Coinvestar is not your broker, intermediary, agent, or advisor and has no fiduciary
relationship or obligation to you in connection with any trades or other decisions or activities
undertaken by you using Coinvestar Services. We do not monitor whether your use
of Coinvestar Services is consistent with your financial goals and objectives. It is up
...
transacting on the Coinvestar Services, and you acknowledge that Coins
Exchange does not provide legal or tax advice relative to these transactions. If you have
any doubts about your tax status or obligations when using Coinvestar Services, or
with respect to the Digital Assets held to the credit of your Coinvestar account, you
...
applicable law, Coinvestar shall withhold taxes related to your transactions,
...
result in withholding taxes by Coinvestar , to be remitted to tax authorities as defined
...
of rapid price movements.`,
  },
  {
    ...
    body: `Our fees and charges are set out here. Coinvestar may, in its discretion, update the
...
`,
  },
  {
    ...
    body: `We do not guarantee that the Coinvestar Services will be available at any particular
time or that Coinvestar Services will not be subject to unplanned service outages or
...
in the provision of Coinvestar Services. You may be subject to the terms &
conditions of these third parties, and Coinvestar may not be responsible for any loss
that these third parties may cause to you.`,
  },
  {
    heading: "K. Security Risk",
    body: `It is not possible for Coinvestar to eliminate all security risks. You are responsible for
keeping your Coinvestar Account password safe, and you may be responsible for all
the transactions under your Coinvestar Account, whether you authorized them or
